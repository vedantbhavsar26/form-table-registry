...
export const registryUi: Registry["items"] = [
	{
		...
		description:
			"A collection of reusable form field components, hooks, utilities, and types.",
		files: [
			// UI components
			{
			...
			// Hooks
			{ path: "hooks/form-field/useForm.tsx", type: "registry:hook" },
	...
	},
	{
		...
		files: [
			...
			{ path: "hooks/data-table/use-callback-ref.ts", type: "registry:hook" },
			{ path: "hooks/data-table/use-data-table.tsx", type: "registry:hook" },
			{
